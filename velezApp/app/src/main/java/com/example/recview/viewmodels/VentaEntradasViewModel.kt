...
class VentaEntradasViewModel : ViewModel() {
    ...
    val partidos = MutableLiveData<MutableList<Partido>>() //el fragment convierte esta variable en una lista cuando observa
    ...
    fun getPartidos(){
      ...
      private suspend fun getAll(): List<Partido> { //es asíncrona por eso tiene el suspend
        ...
        try {
            ...
            //una vez que data deja de ser nulo, pasa al for
